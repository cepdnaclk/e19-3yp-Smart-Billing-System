...
const char* mqttTopic = "3yp_device_1/security_controller";
 
// Use 1 byte of EEPROM space
#define EEPROM_SIZE 1

unsigned long previousMillis = 0; 
const int Interval = 1000; //--> Photo capture every 20 seconds.
...
void loop() {
  if (!client.connected()) {
    client.connect("ESP32_SECURITY_Client");
  ...
  if (currentMillis - previousMillis >= Interval) {
    ...
    JsonObject weightMeasure = data.createNestedObject("security_measure");
